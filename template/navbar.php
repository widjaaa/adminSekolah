 <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?= $main_url ?>">SMA Widjaya</a>
            <!-- Sidebar Toggle-->
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img src="<?= $main_url ?>assets/img/<?= $profile['foto'] ?>" class="img-fluid rounded-start " width="100%" alt="gambar user">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h4 class="card-title mb-3 text-capitalize ps-1"><?= $profile['username'] ?></h4><hr>
         <div class="row">          
